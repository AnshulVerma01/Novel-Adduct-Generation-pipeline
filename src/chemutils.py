...
def load_vocabulary():
	datafile = "/home/shivaji/trail/data/vocabulary.txt"
...
def smiles2graph(smiles):
    ...
    #except AssertionError:
        #print("The condition in the assert statement was not fulfilled.")
    ...
    for neighbor_atom in neighbor_atom_set:
        ...
        for i,v in enumerate(atom_lst):
            ...
            for v1 in [atom_lst[i-1], atom_lst[i+1-len(atom_lst)]]: 
                v1_idx = v1.GetIdx()
                if fragment_mol.GetBondBetweenAtoms(v_idx, v1_idx) is None:
                    continue
